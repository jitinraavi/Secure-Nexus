        ...
        <div className="flex w-full shrink-0 flex-col gap-3 lg:w-64">
          ...
          {selected ? (
           <div className="space-y-2 rounded-xl border border-slate-800 bg-slate-950/50 p-3">
              ...
              <label className="block text-[11px] text-slate-400">PBR finish<select value={selected.finish ?? "satin"} onChange={(e) => patchFurniture(selected.id, { finish: e.target.value as FurnitureItem["finish"] })} className="mt-1 w-full rounded-lg border border-slate-700 bg-slate-900 px-2 py-2 text-xs text-slate-200"><option value="matte">Matte</option><option value="satin">Satin</option><option value="glossy">Glossy</option><option value="metallic">Metallic</option><option value="glass">Glass</option></select></label>
